...
public class DisplayUtils {
    ...
    public static int px2dp(float pxValue) {
        return (int) (pxValue / getDM(Utils.getApp()).density + 0.5f);
    }

    public static int dp2px(float dpVaule) {
        return (int) (dpVaule * getDM(Utils.getApp()).density + 0.5f);
    }

    public static int sp2px(float spValue) {
        return (int) (spValue * getDM(Utils.getApp()).scaledDensity + 0.5f);
    }

    public static int px2sp(float pxValue) {
        return (int) (pxValue / getDM(Utils.getApp()).scaledDensity + 0.5);
    }
    ...
    public static int sp2px(Context context, float spValue) {
        return (int) (spValue * getDM(context).scaledDensity + 0.5f);
    }

    public static int px2sp(Context context, float pxValue) {
        return (int) (pxValue / getDM(context).scaledDensity + 0.5);
    }
